...
//             reverseButtons: true,
//             width: "20rem", // small size
//             customClass: {
//                 popup: "rounded-xl shadow-lg p-5",
//                 title: "text-base font-semibold text-gray-800",
//                 htmlContainer: "text-sm text-gray-600",
//                 confirmButton:
//                     "bg-red-500 text-white px-4 py-2 rounded-md text-sm hover:bg-red-600 transition-colors",
//                 cancelButton:
...
//                                         <PopoverPanel className="absolute right-0 z-30 mt-2 w-64 bg-white rounded-2xl shadow-xl ring-1 ring-black/5 overflow-hidden">
//                                             {/* Profile Section */}
...
//                                     {[
//                                         ['SERVICES Status', YoungBazerService],
//                                     ].map(([label, data]) => (
                ...
                <nav className="flex items-center justify-between py-3">
                    <div className="flex-1 flex items-center lg:justify-start">
                        <a href="/" className="flex items-center">
                            <img src={logo} alt="Logo" className="h-10 w-auto" />
                            <span className="ml-2 text-xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">Dashboard</span>
                        </a>
                    </div>
