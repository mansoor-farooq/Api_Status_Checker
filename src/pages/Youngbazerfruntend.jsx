    ...
    <Layout>
      ...
      <div className="container mx-auto px-2 sm:px-4 py-4 sm:py-6 mt-6 shadow-xl">
        ...
        <div className="w-full overflow-x-auto shadow-xl">
          ...
          {/* Pagination */}
          {/* <div className="w-full bg-[#9E9E9E]  text-black px-2 py-1.5">
            <div className="flex flex-col xs:flex-row items-center justify-between gap-1 w-full">
              <div className="w-full xs:w-auto text-center xs:text-left text-xs">
                <span className="font-medium">
              ...
              <div className="w-full xs:w-auto flex items-center justify-between gap-1">
                <button
                  className="flex-1 xs:flex-none flex items-center text-black justify-center px-2 py-0.5 rounded border border-black hover:bg-[#414141] disabled:opacity-50 text-xs min-w-[60px]"
                  onClick={() => setCurrentPage(prev => Math.max(prev - 1, 1))}
                  disabled={currentPage === 1 || loading}
                >
                  <svg className="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button
                  className="flex-1 xs:flex-none flex items-center justify-center px-2 py-0.5 rounded border text-black  border-black hover:bg-[#414141] disabled:opacity-50 text-xs min-w-[60px]"
                  onClick={() => setCurrentPage(prev => (prev < totalPages ? prev + 1 : prev))}
                  disabled={currentPage === totalPages || loading}
                >
                  Next
